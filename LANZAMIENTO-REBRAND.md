...
12. ✅ **Catálogo y precios.** Traffic Handle y el duplicado "The Urban Leash 1.6m — Brownstone / Olive District" se quedan en borrador, por decisión. Precios: el 11 de septiembre Paulette bajó 15% todo menos el collar (decisión confirmada el 25): Urban Leash 1.6 m $1,258, 1.2 m $1,182, Crossbody $916, Long Leash 3 m $946, Long Leash 5 m $1,212, Collar $566. La lista del Cost Studio en Notion sigue en los precios de julio ($1,480, etc.); si algún día se recalcula ahí, recordar el −15%. **La opción "Slider" (No/Si) ya es "Mosquetón" (Lobster / Carabiner de uso rudo)** en las dos Urban Leash, sobre las mismas variantes; el carabiner va al mismo precio que el lobster (le costó $120 contra $155.84 del lobster, así que la fórmula del Cost Studio no lo encarece). Ojo con el inventario: las variantes de carabiner heredaron las 5 piezas que tenía cada "Slider: Sí".
...
16. ✅ **Constructor 3D (PR #45, actualizado el 25 de septiembre).** "Diseña la tuya" en la galería de las dos Urban Leash, pintado por los círculos de acabado. El motor ya trae lo nuevo de kyn-catalogo: el **mosquetón opcional** (lobster o carabiner de uso rudo) y el **nombre en letras** sobre la tira (A–Z y los dijes ✿ ☾ ★ ♥, con tamaño y posición). Los dos llegan **apagados**: en Personalizar › Product information › Constructor 3D cada uno se puede mostrar solo para verlo o mandar en el pedido como propiedad del artículo (no cambian el precio). El mosquetón ya es una opción real del producto ("Mosquetón": Lobster / Carabiner de uso rudo, en lugar de "Slider"), así que esa opción maneja el 3D y el precio sale de la variante; el ajuste de modo del mosquetón solo aplica a productos sin la opción. Pendientes suyos, ninguno bloquea: probarlo en un iPhone y un Android reales, decidir si el carabiner y el nombre cuestan más (entonces conviene volverlos opción del producto y conectarlos como los acabados), conectar el slider cuando exista el modelo, y las piezas que faltan en el abecedario (A propia, Ñ, números).
